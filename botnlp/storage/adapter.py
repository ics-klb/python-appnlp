...
class StorageAdapter(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.set_tagger(**kwargs)


    def set_tagger(self, **kwargs):
        from botnlp.utils import languages
        from botnlp.nlu.tagging import PosLemmaTagger
    ...
    def connect(self, **kwargs):
        """
        Connec multiple statement entries.
        """
        raise self.AdapterMethodNotImplementedError(
            'The `connect` method is not implemented by this adapter.'
        )
    ...
    def get_statement_object(self):
        from botnlp.nlu.conversation import Statement
    ...
    class StorageException(Exception):
        def __init__(self, message=None):
            default = 'The storage currently contains no entries.'
            super().__init__(message or default)