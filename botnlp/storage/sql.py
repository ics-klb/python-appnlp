...
class SQLStorageAdapter(StorageAdapter):
    """
    The SQLStorage allows ChatterBot to store conversation
    ...
    def get_statement_model(self):
        ...
        """
        from botnlp.storage.sqlalchemy.models import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from botnlp.storage.sqlalchemy.models import Tag
        return Tag

    def model_to_object(self, statement):
        from botnlp.nlu.conversation import Statement as StatementObject
    ...
    def create_database(self):
        ...
        """
        from botnlp.storage.sqlalchemy.models import Base
